...
const DATA = {
  ...
  caseStudies: [
    ...
    },
    {
      ...
      value: "Confidential",
      description:
        "Ginjo Construction was appointed to provide procurement and tendering support, alongside commercial management of an existing logistics contract for the appointed Logistics and Enabling Works subcontractor. The role required immediate integration into a live, complex delivery environment while establishing the commercial structure needed to support long-term programme objectives.",
      linkLabel: "See Case Study",
      minutes: 4,
      image:
